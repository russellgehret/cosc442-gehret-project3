 ...
 *
 * @generatedBy CodePro at 3/5/17 8:29 PM
 * @author Russell
...
public class VendingMachineTest {
	...
	public void testAddItem() {
		...
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 1.50);
		fixture.addItem(VendItem1, "A");
	}
	@Test (expected = Exception.class)
	public void testAddItemException() {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 1.50);
		VendingMachineItem VendItem2 = new VendingMachineItem("Candy", 1.50);
		fixture.addItem(VendItem1, "A");
		fixture.addItem(VendItem2, "A");
	}
	@Test (expected = Exception.class)
	public void testAddItemException2() {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 1.50);		
		fixture.addItem(VendItem1, "F");
	}
	...
	/**
	 * Run the double getSlotIndex() method test.
	 *
	 * @throws Exception
	 *
	 * @generatedBy CodePro at 3/5/17 8:29 PM
	...
	public void getSlotIndex() {
		...
		String C = "C";
		String D = "D";
		assertEquals(0, fixture.getSlotIndex(A));	
		assertEquals(1, fixture.getSlotIndex(B));	
		assertEquals(2, fixture.getSlotIndex(C));	
		assertEquals(3, fixture.getSlotIndex(D));	
	}
	/**
	...
	public void testMakePurchase() {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 2.0);
		fixture.insertMoney(2.25);
		fixture.addItem(VendItem1,"A" );
	...
	public void testMakePurchaseNoMoney() {
		...
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 2.0);
		fixture.addItem(VendItem1, "A");
		assertFalse(fixture.makePurchase("A"));
		assertFalse(fixture.makePurchase("B"));
	}
	@Test
	...
	public void testRemoveItem() {
		VendingMachine fixture = new VendingMachine();
		VendingMachineItem VendItem1 = new VendingMachineItem("Chips", 2.0);
		fixture.addItem(VendItem1, "C");
		fixture.removeItem("C");
	}
